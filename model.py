...
def authsend(tpub,pasw):
    ...
    sf_1.place(x=270,y = 0)
    frame2.place(x = 270,y = 650,width=650,height=60)
    return
...
sf_1 = ScrolledFrame(root, width=620, height=620,scrollbars = 'vertical')
...
button_addt=scrButton(frame3, "+", addT,2)
# frame3.pack(side=LEFT, fill=X)
# frame1.pack(side=TOP, fill=X)
...
msg_entry.place(x = 10,y = 5, width=560,height= 50)
msg_button.place(x = 580,y = 5,width = 50,height=50)
